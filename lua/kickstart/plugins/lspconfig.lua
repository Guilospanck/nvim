    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          --  Uses CMD T mapped using Alacritty
          map('', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[W]orkspace [S]ymbols')
          ...
          -- INFO: Comment to not enable this highlighting which sucks when you
          -- wanna change a single variable or you wanna know exactly where your
          -- cursor is
